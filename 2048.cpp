...
void make_indexers(const std::string& res = "") {
	...
	indexer::make(0x00012345, utils::index6t<0x0,0x1,0x2,0x3,0x4,0x5>);
	indexer::make(0x0037bf26, utils::index6t<0x3,0x7,0xb,0xf,0x2,0x6>);
	indexer::make(0x00fedcba, utils::index6t<0xf,0xe,0xd,0xc,0xb,0xa>);
	indexer::make(0x00c840d9, utils::index6t<0xc,0x8,0x4,0x0,0xd,0x9>);
	indexer::make(0x00321076, utils::index6t<0x3,0x2,0x1,0x0,0x7,0x6>);
	indexer::make(0x00fb73ea, utils::index6t<0xf,0xb,0x7,0x3,0xe,0xa>);
	indexer::make(0x00cdef89, utils::index6t<0xc,0xd,0xe,0xf,0x8,0x9>);
	indexer::make(0x00048c15, utils::index6t<0x0,0x4,0x8,0xc,0x1,0x5>);
	indexer::make(0x00456789, utils::index6t<0x4,0x5,0x6,0x7,0x8,0x9>);
	indexer::make(0x0026ae15, utils::index6t<0x2,0x6,0xa,0xe,0x1,0x5>);
	indexer::make(0x00ba9876, utils::index6t<0xb,0xa,0x9,0x8,0x7,0x6>);
	indexer::make(0x00d951ea, utils::index6t<0xd,0x9,0x5,0x1,0xe,0xa>);
	indexer::make(0x007654ba, utils::index6t<0x7,0x6,0x5,0x4,0xb,0xa>);
	indexer::make(0x00ea62d9, utils::index6t<0xe,0xa,0x6,0x2,0xd,0x9>);
	indexer::make(0x0089ab45, utils::index6t<0x8,0x9,0xa,0xb,0x4,0x5>);
	indexer::make(0x00159d26, utils::index6t<0x1,0x5,0x9,0xd,0x2,0x6>);
	...
	indexer::make(0x00123567, utils::index6t<0x1,0x2,0x3,0x5,0x6,0x7>);
	indexer::make(0x007bf6ae, utils::index6t<0x7,0xb,0xf,0x6,0xa,0xe>);
	indexer::make(0x00edca98, utils::index6t<0xe,0xd,0xc,0xa,0x9,0x8>);
	indexer::make(0x00840951, utils::index6t<0x8,0x4,0x0,0x9,0x5,0x1>);
	indexer::make(0x00210654, utils::index6t<0x2,0x1,0x0,0x6,0x5,0x4>);
	indexer::make(0x00b73a62, utils::index6t<0xb,0x7,0x3,0xa,0x6,0x2>);
	indexer::make(0x00def9ab, utils::index6t<0xd,0xe,0xf,0x9,0xa,0xb>);
	indexer::make(0x0048c59d, utils::index6t<0x4,0x8,0xc,0x5,0x9,0xd>);
	indexer::make(0x005679ab, utils::index6t<0x5,0x6,0x7,0x9,0xa,0xb>);
	indexer::make(0x006ae59d, utils::index6t<0x6,0xa,0xe,0x5,0x9,0xd>);
	indexer::make(0x00a98654, utils::index6t<0xa,0x9,0x8,0x6,0x5,0x4>);
	indexer::make(0x00951a62, utils::index6t<0x9,0x5,0x1,0xa,0x6,0x2>);
	indexer::make(0x00654a98, utils::index6t<0x6,0x5,0x4,0xa,0x9,0x8>);
	indexer::make(0x00a62951, utils::index6t<0xa,0x6,0x2,0x9,0x5,0x1>);
	indexer::make(0x009ab567, utils::index6t<0x9,0xa,0xb,0x5,0x6,0x7>);
	indexer::make(0x0059d6ae, utils::index6t<0x5,0x9,0xd,0x6,0xa,0xe>);
	...
	indexer::make(0x00123567, utils::index7t<0x0,0x1,0x2,0x3,0x5,0x6,0x7>);
	indexer::make(0x037bf6ae, utils::index7t<0x3,0x7,0xb,0xf,0x6,0xa,0xe>);
	indexer::make(0x0fedca98, utils::index7t<0xf,0xe,0xd,0xc,0xa,0x9,0x8>);
	indexer::make(0x0c840951, utils::index7t<0xc,0x8,0x4,0x0,0x9,0x5,0x1>);
	indexer::make(0x03210654, utils::index7t<0x3,0x2,0x1,0x0,0x6,0x5,0x4>);
	indexer::make(0x0fb73a62, utils::index7t<0xf,0xb,0x7,0x3,0xa,0x6,0x2>);
	indexer::make(0x0cdef9ab, utils::index7t<0xc,0xd,0xe,0xf,0x9,0xa,0xb>);
	indexer::make(0x0048c59d, utils::index7t<0x0,0x4,0x8,0xc,0x5,0x9,0xd>);
	indexer::make(0x045679ab, utils::index7t<0x4,0x5,0x6,0x7,0x9,0xa,0xb>);
	indexer::make(0x026ae59d, utils::index7t<0x2,0x6,0xa,0xe,0x5,0x9,0xd>);
	indexer::make(0x0ba98654, utils::index7t<0xb,0xa,0x9,0x8,0x6,0x5,0x4>);
	indexer::make(0x0d951a62, utils::index7t<0xd,0x9,0x5,0x1,0xa,0x6,0x2>);
	indexer::make(0x07654a98, utils::index7t<0x7,0x6,0x5,0x4,0xa,0x9,0x8>);
	indexer::make(0x0ea62951, utils::index7t<0xe,0xa,0x6,0x2,0x9,0x5,0x1>);
	indexer::make(0x089ab567, utils::index7t<0x8,0x9,0xa,0xb,0x5,0x6,0x7>);
	indexer::make(0x0159d6ae, utils::index7t<0x1,0x5,0x9,0xd,0x6,0xa,0xe>);
	indexer::make(0x001237bf, utils::index7t<0x0,0x1,0x2,0x3,0x7,0xb,0xf>);
	indexer::make(0x037bfedc, utils::index7t<0x3,0x7,0xb,0xf,0xe,0xd,0xc>);
	indexer::make(0x0fedc840, utils::index7t<0xf,0xe,0xd,0xc,0x8,0x4,0x0>);
	indexer::make(0x0c840123, utils::index7t<0xc,0x8,0x4,0x0,0x1,0x2,0x3>);
	indexer::make(0x0321048c, utils::index7t<0x3,0x2,0x1,0x0,0x4,0x8,0xc>);
	indexer::make(0x0fb73210, utils::index7t<0xf,0xb,0x7,0x3,0x2,0x1,0x0>);
	indexer::make(0x0cdefb73, utils::index7t<0xc,0xd,0xe,0xf,0xb,0x7,0x3>);
	indexer::make(0x0048cdef, utils::index7t<0x0,0x4,0x8,0xc,0xd,0xe,0xf>);
