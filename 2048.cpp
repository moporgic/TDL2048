...
void make_indexers() {
	...
	indexer::make(0x00012367, utils::index6t<0x0,0x1,0x2,0x3,0x6,0x7>);
	indexer::make(0x0037bfae, utils::index6t<0x3,0x7,0xb,0xf,0xa,0xe>);
	indexer::make(0x00fedc98, utils::index6t<0xf,0xe,0xd,0xc,0x9,0x8>);
	indexer::make(0x00c84051, utils::index6t<0xc,0x8,0x4,0x0,0x5,0x1>);
	indexer::make(0x00fb7362, utils::index6t<0xf,0xb,0x7,0x3,0x6,0x2>);
	indexer::make(0x00cdefab, utils::index6t<0xc,0xd,0xe,0xf,0xa,0xb>);
	indexer::make(0x00048c9d, utils::index6t<0x0,0x4,0x8,0xc,0x9,0xd>);
	indexer::make(0x00321054, utils::index6t<0x3,0x2,0x1,0x0,0x5,0x4>);
	indexer::make(0x004567ab, utils::index6t<0x4,0x5,0x6,0x7,0xa,0xb>);
	indexer::make(0x0026ae9d, utils::index6t<0x2,0x6,0xa,0xe,0x9,0xd>);
	indexer::make(0x00ba9854, utils::index6t<0xb,0xa,0x9,0x8,0x5,0x4>);
	indexer::make(0x00d95162, utils::index6t<0xd,0x9,0x5,0x1,0x6,0x2>);
	indexer::make(0x00ea6251, utils::index6t<0xe,0xa,0x6,0x2,0x5,0x1>);
	indexer::make(0x0089ab67, utils::index6t<0x8,0x9,0xa,0xb,0x6,0x7>);
	indexer::make(0x00159dae, utils::index6t<0x1,0x5,0x9,0xd,0xa,0xe>);
	indexer::make(0x00765498, utils::index6t<0x7,0x6,0x5,0x4,0x9,0x8>);
	indexer::make(0x00012456, utils::index6t<0x0,0x1,0x2,0x4,0x5,0x6>);
	indexer::make(0x0037b26a, utils::index6t<0x3,0x7,0xb,0x2,0x6,0xa>);
	indexer::make(0x00fedba9, utils::index6t<0xf,0xe,0xd,0xb,0xa,0x9>);
	indexer::make(0x00c84d95, utils::index6t<0xc,0x8,0x4,0xd,0x9,0x5>);
	indexer::make(0x00fb7ea6, utils::index6t<0xf,0xb,0x7,0xe,0xa,0x6>);
	indexer::make(0x00cde89a, utils::index6t<0xc,0xd,0xe,0x8,0x9,0xa>);
	indexer::make(0x00048159, utils::index6t<0x0,0x4,0x8,0x1,0x5,0x9>);
	indexer::make(0x00321765, utils::index6t<0x3,0x2,0x1,0x7,0x6,0x5>);
	indexer::make(0x0045689a, utils::index6t<0x4,0x5,0x6,0x8,0x9,0xa>);
	indexer::make(0x0026a159, utils::index6t<0x2,0x6,0xa,0x1,0x5,0x9>);
	indexer::make(0x00ba9765, utils::index6t<0xb,0xa,0x9,0x7,0x6,0x5>);
	indexer::make(0x00d95ea6, utils::index6t<0xd,0x9,0x5,0xe,0xa,0x6>);
	indexer::make(0x00ea6d95, utils::index6t<0xe,0xa,0x6,0xd,0x9,0x5>);
	indexer::make(0x0089a456, utils::index6t<0x8,0x9,0xa,0x4,0x5,0x6>);
	indexer::make(0x0015926a, utils::index6t<0x1,0x5,0x9,0x2,0x6,0xa>);
	indexer::make(0x00765ba9, utils::index6t<0x7,0x6,0x5,0xb,0xa,0x9>);
	indexer::make(0x00000123, utils::index4t<0x0,0x1,0x2,0x3>);
	indexer::make(0x00004567, utils::index4t<0x4,0x5,0x6,0x7>);
	indexer::make(0x000089ab, utils::index4t<0x8,0x9,0xa,0xb>);
	indexer::make(0x0000cdef, utils::index4t<0xc,0xd,0xe,0xf>);
	indexer::make(0x000037bf, utils::index4t<0x3,0x7,0xb,0xf>);
	indexer::make(0x000026ae, utils::index4t<0x2,0x6,0xa,0xe>);
	indexer::make(0x0000159d, utils::index4t<0x1,0x5,0x9,0xd>);
	indexer::make(0x0000048c, utils::index4t<0x0,0x4,0x8,0xc>);
	indexer::make(0x0000fedc, utils::index4t<0xf,0xe,0xd,0xc>);
	indexer::make(0x0000ba98, utils::index4t<0xb,0xa,0x9,0x8>);
	indexer::make(0x00007654, utils::index4t<0x7,0x6,0x5,0x4>);
	indexer::make(0x00003210, utils::index4t<0x3,0x2,0x1,0x0>);
	indexer::make(0x0000c840, utils::index4t<0xc,0x8,0x4,0x0>);
	indexer::make(0x0000d951, utils::index4t<0xd,0x9,0x5,0x1>);
	indexer::make(0x0000ea62, utils::index4t<0xe,0xa,0x6,0x2>);
	indexer::make(0x0000fb73, utils::index4t<0xf,0xb,0x7,0x3>);
	indexer::make(0x00000145, utils::index4t<0x0,0x1,0x4,0x5>);
	indexer::make(0x00001256, utils::index4t<0x1,0x2,0x5,0x6>);
	indexer::make(0x00002367, utils::index4t<0x2,0x3,0x6,0x7>);
	indexer::make(0x00004589, utils::index4t<0x4,0x5,0x8,0x9>);
	indexer::make(0x0000569a, utils::index4t<0x5,0x6,0x9,0xa>);
	indexer::make(0x000067ab, utils::index4t<0x6,0x7,0xa,0xb>);
	indexer::make(0x000089cd, utils::index4t<0x8,0x9,0xc,0xd>);
	indexer::make(0x00009ade, utils::index4t<0x9,0xa,0xd,0xe>);
	indexer::make(0x0000abef, utils::index4t<0xa,0xb,0xe,0xf>);
	indexer::make(0x00003726, utils::index4t<0x3,0x7,0x2,0x6>);
	indexer::make(0x00007b6a, utils::index4t<0x7,0xb,0x6,0xa>);
	indexer::make(0x0000bfae, utils::index4t<0xb,0xf,0xa,0xe>);
	indexer::make(0x00002615, utils::index4t<0x2,0x6,0x1,0x5>);
	indexer::make(0x00006a59, utils::index4t<0x6,0xa,0x5,0x9>);
	indexer::make(0x0000ae9d, utils::index4t<0xa,0xe,0x9,0xd>);
	indexer::make(0x00001504, utils::index4t<0x1,0x5,0x0,0x4>);
	indexer::make(0x00005948, utils::index4t<0x5,0x9,0x4,0x8>);
	indexer::make(0x00009d8c, utils::index4t<0x9,0xd,0x8,0xc>);
	indexer::make(0x0000feba, utils::index4t<0xf,0xe,0xb,0xa>);
	indexer::make(0x0000eda9, utils::index4t<0xe,0xd,0xa,0x9>);
	indexer::make(0x0000dc98, utils::index4t<0xd,0xc,0x9,0x8>);
	indexer::make(0x0000ba76, utils::index4t<0xb,0xa,0x7,0x6>);
	indexer::make(0x0000a965, utils::index4t<0xa,0x9,0x6,0x5>);
	indexer::make(0x00009854, utils::index4t<0x9,0x8,0x5,0x4>);
	indexer::make(0x00007632, utils::index4t<0x7,0x6,0x3,0x2>);
	indexer::make(0x00006521, utils::index4t<0x6,0x5,0x2,0x1>);
	indexer::make(0x00005410, utils::index4t<0x5,0x4,0x1,0x0>);
	indexer::make(0x0000c8d9, utils::index4t<0xc,0x8,0xd,0x9>);
	indexer::make(0x00008495, utils::index4t<0x8,0x4,0x9,0x5>);
	indexer::make(0x00004051, utils::index4t<0x4,0x0,0x5,0x1>);
	indexer::make(0x0000d9ea, utils::index4t<0xd,0x9,0xe,0xa>);
	indexer::make(0x000095a6, utils::index4t<0x9,0x5,0xa,0x6>);
	indexer::make(0x00005162, utils::index4t<0x5,0x1,0x6,0x2>);
	indexer::make(0x0000eafb, utils::index4t<0xe,0xa,0xf,0xb>);
	indexer::make(0x0000a6b7, utils::index4t<0xa,0x6,0xb,0x7>);
	indexer::make(0x00006273, utils::index4t<0x6,0x2,0x7,0x3>);
	indexer::make(0x00003276, utils::index4t<0x3,0x2,0x7,0x6>);
	indexer::make(0x00002165, utils::index4t<0x2,0x1,0x6,0x5>);
	indexer::make(0x00001054, utils::index4t<0x1,0x0,0x5,0x4>);
	indexer::make(0x000076ba, utils::index4t<0x7,0x6,0xb,0xa>);
	indexer::make(0x000065a9, utils::index4t<0x6,0x5,0xa,0x9>);
	indexer::make(0x00005498, utils::index4t<0x5,0x4,0x9,0x8>);
	indexer::make(0x0000bafe, utils::index4t<0xb,0xa,0xf,0xe>);
	indexer::make(0x0000a9ed, utils::index4t<0xa,0x9,0xe,0xd>);
	indexer::make(0x000098dc, utils::index4t<0x9,0x8,0xd,0xc>);
	indexer::make(0x0000fbea, utils::index4t<0xf,0xb,0xe,0xa>);
	indexer::make(0x0000b7a6, utils::index4t<0xb,0x7,0xa,0x6>);
	indexer::make(0x00007362, utils::index4t<0x7,0x3,0x6,0x2>);
	indexer::make(0x0000ead9, utils::index4t<0xe,0xa,0xd,0x9>);
	indexer::make(0x0000a695, utils::index4t<0xa,0x6,0x9,0x5>);
	indexer::make(0x00006251, utils::index4t<0x6,0x2,0x5,0x1>);
	indexer::make(0x0000d9c8, utils::index4t<0xd,0x9,0xc,0x8>);
	indexer::make(0x00009584, utils::index4t<0x9,0x5,0x8,0x4>);
	indexer::make(0x00005140, utils::index4t<0x5,0x1,0x4,0x0>);
	indexer::make(0x0000cd89, utils::index4t<0xc,0xd,0x8,0x9>);
	indexer::make(0x0000de9a, utils::index4t<0xd,0xe,0x9,0xa>);
	indexer::make(0x0000efab, utils::index4t<0xe,0xf,0xa,0xb>);
	indexer::make(0x00008945, utils::index4t<0x8,0x9,0x4,0x5>);
	indexer::make(0x00009a56, utils::index4t<0x9,0xa,0x5,0x6>);
	indexer::make(0x0000ab67, utils::index4t<0xa,0xb,0x6,0x7>);
	indexer::make(0x00004501, utils::index4t<0x4,0x5,0x0,0x1>);
	indexer::make(0x00005612, utils::index4t<0x5,0x6,0x1,0x2>);
	indexer::make(0x00006723, utils::index4t<0x6,0x7,0x2,0x3>);
	indexer::make(0x00000415, utils::index4t<0x0,0x4,0x1,0x5>);
	indexer::make(0x00004859, utils::index4t<0x4,0x8,0x5,0x9>);
	indexer::make(0x00008c9d, utils::index4t<0x8,0xc,0x9,0xd>);
	indexer::make(0x00001526, utils::index4t<0x1,0x5,0x2,0x6>);
	indexer::make(0x0000596a, utils::index4t<0x5,0x9,0x6,0xa>);
	indexer::make(0x00009dae, utils::index4t<0x9,0xd,0xa,0xe>);
	indexer::make(0x00002637, utils::index4t<0x2,0x6,0x3,0x7>);
	indexer::make(0x00006a7b, utils::index4t<0x6,0xa,0x7,0xb>);
	indexer::make(0x0000aebf, utils::index4t<0xa,0xe,0xb,0xf>);
	indexer::make(0x01234567, utils::index8t<0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7>);
	indexer::make(0x456789ab, utils::index8t<0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb>);
	indexer::make(0x37bf26ae, utils::index8t<0x3,0x7,0xb,0xf,0x2,0x6,0xa,0xe>);
	indexer::make(0x26ae159d, utils::index8t<0x2,0x6,0xa,0xe,0x1,0x5,0x9,0xd>);
	indexer::make(0xfedcba98, utils::index8t<0xf,0xe,0xd,0xc,0xb,0xa,0x9,0x8>);
	indexer::make(0xba987654, utils::index8t<0xb,0xa,0x9,0x8,0x7,0x6,0x5,0x4>);
	indexer::make(0xc840d951, utils::index8t<0xc,0x8,0x4,0x0,0xd,0x9,0x5,0x1>);
	indexer::make(0xd951ea62, utils::index8t<0xd,0x9,0x5,0x1,0xe,0xa,0x6,0x2>);
	indexer::make(0x32107654, utils::index8t<0x3,0x2,0x1,0x0,0x7,0x6,0x5,0x4>);
	indexer::make(0x7654ba98, utils::index8t<0x7,0x6,0x5,0x4,0xb,0xa,0x9,0x8>);
	indexer::make(0xfb73ea62, utils::index8t<0xf,0xb,0x7,0x3,0xe,0xa,0x6,0x2>);
	indexer::make(0xea62d951, utils::index8t<0xe,0xa,0x6,0x2,0xd,0x9,0x5,0x1>);
	indexer::make(0xcdef89ab, utils::index8t<0xc,0xd,0xe,0xf,0x8,0x9,0xa,0xb>);
	indexer::make(0x89ab4567, utils::index8t<0x8,0x9,0xa,0xb,0x4,0x5,0x6,0x7>);
	indexer::make(0x048c159d, utils::index8t<0x0,0x4,0x8,0xc,0x1,0x5,0x9,0xd>);
	indexer::make(0x159d26ae, utils::index8t<0x1,0x5,0x9,0xd,0x2,0x6,0xa,0xe>);
