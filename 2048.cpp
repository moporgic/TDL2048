...
struct make {
	...
	struct index4t {
		...
		template<u32 i> static typename std::enable_if<(i != 8), void>::type isomorphic(bool iso) {
			...
			make(vtos({x[t0], x[t1], x[t2], x[t3]}), index::indexpt<x[t0], x[t1], x[t2], x[t3]>);
	...
	struct index5t {
		...
		template<u32 i> static typename std::enable_if<(i != 8), void>::type isomorphic(bool iso) {
			constexpr board x = isoindex[i];
			make(vtos({x[t0], x[t1], x[t2], x[t3], x[t4]}), index::indexpt<x[t0], x[t1], x[t2], x[t3], x[t4]>);
			if (iso) isomorphic<i + 1>(iso);
		}
		template<u32 i> static typename std::enable_if<(i >= 8), void>::type isomorphic(bool iso) {}
	};
	...
	struct index6t {
		...
		template<u32 i> static typename std::enable_if<(i != 8), void>::type isomorphic(bool iso) {
			constexpr board x = isoindex[i];
			make(vtos({x[t0], x[t1], x[t2], x[t3], x[t4], x[t5]}), index::indexpt<x[t0], x[t1], x[t2], x[t3], x[t4], x[t5]>);
			if (iso) isomorphic<i + 1>(iso);
		}
		template<u32 i> static typename std::enable_if<(i >= 8), void>::type isomorphic(bool iso) {}
	};
	...
	struct index7t {
		...
		template<u32 i> static typename std::enable_if<(i != 8), void>::type isomorphic(bool iso) {
			constexpr board x = isoindex[i];
			make(vtos({x[t0], x[t1], x[t2], x[t3], x[t4], x[t5], x[t6]}), index::indexpt<x[t0], x[t1], x[t2], x[t3], x[t4], x[t5], x[t6]>);
			if (iso) isomorphic<i + 1>(iso);
		}
		template<u32 i> static typename std::enable_if<(i >= 8), void>::type isomorphic(bool iso) {}
	};
	...
	struct index8t {
		...
		template<u32 i> static typename std::enable_if<(i != 8), void>::type isomorphic(bool iso) {
			constexpr board x = isoindex[i];
			make(vtos({x[t0], x[t1], x[t2], x[t3], x[t4], x[t5], x[t6], x[t7]}), index::indexpt<x[t0], x[t1], x[t2], x[t3], x[t4], x[t5], x[t6], x[t7]>);
			if (iso) isomorphic<i + 1>(iso);
		}
		template<u32 i> static typename std::enable_if<(i >= 8), void>::type isomorphic(bool iso) {}
	};
